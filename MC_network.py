...
# Initialize Xavier initializer for TF2 compatibility
glort_initializer = tf.glorot_uniform_initializer()
...
def MC(input):
    ...
    m1 = tf.layers.conv2d(inputs=input, filters=64, kernel_size=3, strides=1, padding='same',
                          kernel_initializer=glort_initializer, name='mc1')
